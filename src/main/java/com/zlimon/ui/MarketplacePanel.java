...
import com.zlimon.marketplace.LambdaIterator;
import com.zlimon.marketplace.MarketplaceConstants;
import com.zlimon.marketplace.MarketplaceManager;
import com.zlimon.marketplace.MarketplaceProductSorter;
import com.zlimon.marketplace.products.ChannelPointReward;
import com.zlimon.marketplace.products.MarketplaceProduct;
import com.zlimon.marketplace.products.StreamerProduct;
...
public class MarketplacePanel extends JPanel
{
	...
	private void initializeLayout()
	{
		...
		RuneManagerPanel.initializePanelButton(startPanel, startLabel, getPlaybackButtonTitle(), () -> {
		...
		RuneManagerPanel.initializePanelButton(testModePanel, testModeLabel, getTestModeButtonTitle(), () -> {
		...
		RuneManagerPanel.initializePanelButton(chaosModePanel, chaosModeLabel, getChaosModeButtonTitle(), () -> {
		...
		RuneManagerPanel.initializePanelButton(freeModePanel, freeModeLabel, getFreeModeButtonTitle(), () -> {
