...
public abstract class EntityActionPanel<EntityType> extends JPanel {
	...
	static
	{
		final BufferedImage deleteImg = ImageUtil.loadImageResource(RuneManagerPlugin.class, "/delete_icon.png");
		final BufferedImage rerunImg = ImageUtil.loadImageResource(RuneManagerPlugin.class, "/rerun_icon.png");
