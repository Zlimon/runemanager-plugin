...
public class NotificationManager {
	...
	public NotificationManager(RuneManagerPlugin plugin, RuneManagerConfig config, ChatMessageManager chatMessageManager, Client client, TwitchApi twitchApi, MarketplaceManager manager)
	{
		this.plugin = plugin;
		this.config = config;
