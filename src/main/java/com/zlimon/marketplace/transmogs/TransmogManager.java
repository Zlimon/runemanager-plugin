package com.zlimon.marketplace.transmogs;

import com.zlimon.RuneManagerPlugin;
import com.zlimon.marketplace.MarketplaceEffect;
import com.zlimon.marketplace.MarketplaceEffectManager;
import com.zlimon.marketplace.products.EbsEquipmentFrame;
...
import static com.zlimon.marketplace.MarketplaceConstants.TRANSMOG_EFFECT_MAX_SIZE;
...
public class TransmogManager extends MarketplaceEffectManager<EbsEquipmentFrame> {
	...
	public TransmogManager(RuneManagerPlugin plugin, Client client, ItemManager itemManager)
	{
