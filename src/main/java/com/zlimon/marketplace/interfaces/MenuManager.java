package com.zlimon.marketplace.interfaces;
...
import com.zlimon.marketplace.products.EbsMenuOptionFrame;
...
public class MenuManager extends MarketplaceEffectManager<EbsMenuOptionFrame> {
	...
	public MenuManager(RuneManagerConfig config, Client client)
	{
