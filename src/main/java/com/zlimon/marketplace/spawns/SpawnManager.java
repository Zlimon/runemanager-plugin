package com.zlimon.marketplace.spawns;
...
import com.zlimon.marketplace.products.EbsModelPlacement;
import com.zlimon.marketplace.products.EbsRandomRange;
...
public class SpawnManager {
	...
	public SpawnManager(RuneManagerPlugin plugin, Client client, MarketplaceManager manager)
	{
		this.plugin = plugin;
		this.client = client;
