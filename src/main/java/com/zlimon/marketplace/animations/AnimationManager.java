package com.zlimon.marketplace.animations;
...
import com.zlimon.marketplace.products.EbsMovementFrame;
...
import static com.zlimon.marketplace.MarketplaceConstants.MOVEMENT_EFFECT_MAX_SIZE;
...
public class AnimationManager extends MarketplaceEffectManager<EbsMovementFrame> {
	...
	public AnimationManager(RuneManagerPlugin plugin, Client client)
	{
