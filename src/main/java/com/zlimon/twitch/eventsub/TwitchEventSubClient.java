...
//public final static String DEFAULT_TWITCH_WEBSOCKET_URL = "ws://127.0.0.1:8080/ws";
    ...
    public TwitchEventSubClient(RuneManagerPlugin plugin, RuneManagerConfig config, TwitchApi twitchApi, Gson gson, OkHttpClient httpClientTemplate, TwitchEventSubListener listener)
    {
        this.plugin = plugin;
        this.config = config;
