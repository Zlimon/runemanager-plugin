...
public class ItemStateManager {
	...
	public ItemStateManager(RuneManagerPlugin plugin, TwitchState twitchState, Client client, ItemManager itemManager, RuneManagerConfig config)
	{
		this.plugin = plugin;
